            ...
            <section aria-label={"Stock-Component-Card"}
                ...
                <div className="flex flex-row w-full justify-between items-center space-x-3">
                    ...
                    <div className={"flex flex-row items-center space-x-3 w-1/2"}>
                        <ComponentHeader imageUrl={"https://raw.githubusercontent.com/mshah972/PopTrade/63b44d73be90d6a43008c1617a16ca0c7cbe9dc8/src/assets/chart.svg"} title={"S&P 500 Index"} />
                    </div>
